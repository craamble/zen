  ...
  return (
    <div className="card p-8 flex flex-col gap-5">
      <div>
        ...
        <p className="muted text-sm mt-1">A label for this wallet.</p>
      </div>
      ...
      <div className="flex justify-between gap-3 mt-2">
        <Link href="/onboarding/import/seed" className="btn btn-ghost">Back</Link>
        <button className="btn btn-primary" disabled={!name.trim() || busy} onClick={onConfirm}>
